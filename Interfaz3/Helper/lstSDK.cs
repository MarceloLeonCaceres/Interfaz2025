...
namespace SDK
{
    public class lstSDK
    {
        ...
        public List<zkemkeeper.CZKEM> axCZKEM1 = new List<zkemkeeper.CZKEM>();
        ...
        public int sta_ConnectTCP(string ip, string port, string commKey)
        {
            ...
            int idwErrorCode = 0;
            for (int i = 0; i < axCZKEM1.Count - 1; i++) { 

                axCZKEM1[i].SetCommPassword(Convert.ToInt32(commKey));

                if (bIsConnected == true)
                {
                    axCZKEM1[i].Disconnect();
                    // Pendiente
                    // sta_UnRegRealTime();
                ...
                if (axCZKEM1[i].Connect_Net(ip, Convert.ToInt32(port)) == true)
                {
                ...
                {
                    axCZKEM1[i].GetLastError(ref idwErrorCode);
                    // Envía mensaje
